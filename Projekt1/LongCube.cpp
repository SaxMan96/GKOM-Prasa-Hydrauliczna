...
LongCube::LongCube(const char * imgname)
{
	imgName = imgname;
}
LongCube::LongCube(GLfloat width, GLfloat height, GLfloat depth, GLfloat xpos, GLfloat ypos, GLfloat zpos, const char * imgname, float textureSegments)
{
	imgName = imgname;
	GLfloat v[] = {
		// coordinates								// texture
		...
		width + xpos, height + ypos, depth + zpos,	textureSegments, 1.0f,
		0.0f  + xpos, height + ypos, depth + zpos,	0.0f,			 1.0f,
		0.0f  + xpos, 0.0f   + ypos, 0.0f  + zpos,	textureSegments, 1.0f,
...
//void LongCube::Draw(const glm::mat4& modelTrans, GLuint modelLoc) const
//{
