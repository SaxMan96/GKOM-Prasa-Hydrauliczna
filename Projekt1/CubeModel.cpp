...
//	-0.5f,  0.5f, -0.5f,  0.0f, 0.0f
//};
CubeModel::CubeModel(const char * imgname)
{
	imgName = imgname;
}

CubeModel::CubeModel(GLfloat width, GLfloat height, GLfloat depth, GLfloat xpos, GLfloat ypos, GLfloat zpos, const char * imgname)
{
	cube_coord = {xpos,ypos,zpos};
	imgName = imgname;
	GLfloat v[] = {
		// coordinates								// texture
...
std::vector<GLfloat> CubeModel::getCoord()
{
	return cube_coord;
}
