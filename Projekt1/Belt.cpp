...
Belt::Belt(const char * imgname)
{
	imgName = imgname;
}
Belt::Belt(GLfloat width, GLfloat height, GLfloat depth, GLfloat xpos, GLfloat ypos, GLfloat zpos, const char * imgname, float textureSegments)
{
	imgName = imgname;
	GLfloat v[] = {
		// coordinates								// texture
		0.0f + xpos, 0.0f + ypos, depth + zpos,	    0.0f,			 0.0f,
		width + xpos, 0.0f + ypos, depth + zpos,	textureSegments, 0.0f,
		width + xpos, height + ypos, depth + zpos,	0.0f,			 1.0f,
		0.0f + xpos, height + ypos, depth + zpos,	textureSegments, 1.0f,
		0.0f + xpos, 0.0f + ypos, 0.0f + zpos,	    0.0f,			 1.0f,
		width + xpos, 0.0f + ypos, 0.0f + zpos,  	textureSegments, 1.0f,
		width + xpos, height + ypos, 0.0f + zpos,	0.0f,			 0.0f,
		0.0f + xpos, height + ypos, 0.0f + zpos,	textureSegments, 0.0f
	};
...
//void Belt::Draw(const glm::mat4& modelTrans, GLuint modelLoc) const
//{
